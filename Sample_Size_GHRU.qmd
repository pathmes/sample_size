...
-   Research questions/ objective
    ...
    2.  Identify the association between two variables/ difference between two groups - testing a hypothesis or analytical study. Difference between two means, difference between two percentages, a correlation coefficient etc.

## Descriptive study

-   Estimating population value based on sample findings
-   Larger the sample size more precise estimate (narrower confidence interval)
-   Larger the sample size higher confidence

\

-   Higher the variability larger sample size
...
-   Modify calculation based on sampling method
...
-   Example
    -   Available sample size is 1000
    -   Equal number of exposed & unexposed
    -   \% with outcome
    -   10 & 15
    -   10 & 20
